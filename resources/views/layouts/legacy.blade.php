...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="icon" type="image/vnd.microsoft.icon" rel="nofollow" href="/favicon.ico" />
        <link rel="shortcut icon" type="image/x-icon" rel="nofollow" href="/favicon.ico" />
        ...
        <link rel="stylesheet" type="text/css" rel="nofollow" href="/css/minify.css?nocache2" />
        <link rel="stylesheet" type="text/css" rel="nofollow" href="/css/common.css?nocache2" />
        <link rel="stylesheet" type="text/css" rel="nofollow" href="/css/new-header.css?nocache2" />
        <link rel="nofollow" href="https://plus.google.com/104242186661397386656" rel="publisher" />
        <link rel="nofollow" href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">

        <script type='text/javascript'>
            function jsfile(file){
                //loading this way allows page to render before downloading these resources. i know its weird
...
//            jsfile('//js.hsforms.net/forms/current.js');
            jsfile('//www.google.com/jsapi');
//            jsfile('//w.sharethis.com/button/buttons.js');
//            jsfile('//ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js');
//            jsfile('//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js');
            jsfile('/js/common.js?nocache2');
//            jsfile('/js/slider.js');
            cssfile('//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css');
        </script>
        <script type="text/javascript">var switchTo5x = true;</script>
    </head>
    <body id="top" class="{{ $bodyClass }}">
        <div id="side-nav">
            <img src="{{ URL::asset('images/lojistic.png') }}"/>
            <div>
            ...
            <div>
                <div><span></span> ABOUT LOJISITC</div>
                <div class="sn-links">
            ...
            <div>
                ...
                <div class="sn-links">
                    ...
                    <a rel="nofollow" href="http://www.lojistic.com/blog/">Blog</a>
                </div>
            </div>
        </div>
                ...
                <div id="social-nav">
                    <div>
                        ...
                        <div>
                            ...
                            <a alt="Blog" id="sc_blog" rel="nofollow" href="https://www.lojistic.com/blog/" target="_blank"></a>
                            <a alt="SOURCE REPORTS" id="source_reports" rel="nofollow" href="https://data.lojistic.com/" target="_blank"></a>
                        </div>
                    </div>
                </div>
                <div id="company-nav">
                    <div>
                        <a id="source-logo" rel="nofollow" href="http://www.lojistic.com/">
        ...
        <div id="footer_form">
            ...
            <script type="text/javascript">
                $(document).on('keyup', 'input[name=firstname]', function(e) {
                    if (e.keyCode == 32) {
                        jQuery(this).parents('form').find('input[name=lastname]').focus()
                    }
                });
                hbspt.forms.create({
                    portalId: '68908',
