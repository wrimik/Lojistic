<div class="scroll-footer">
    <div class="container">
        ...
        <!-- the description -->
        <div class="col-lg-2 col-lg-offset-2 col-md-4 col-sm-5 hidden-xs">
        ...
        <div class="col-lg-4 col-md-4 hidden-md hidden-sm hidden-xs" >
            <div class="scroll-footer-form form-inline">
                ...
                <input id="sticky-footer-email" name="hs[email]" class="form-control" placeholder="*email" data-parsley-type="email" required data-parsley-id="10">
                    <input type="hidden" name="Blog_Subscribers" value="/thank-you">
                    <input type="hidden" name="formid" value="fc7f9c17-4ade-404b-b9a9-29cd633499bd">
                    <a id="sticky-footer-btn" class="btn btn-primary orange btn-sm modal-btn input-group-addon "
                    data-modal-title="Thank You!"
                    data-modal-body="#my-modal-body">
                    Subscribe</a>
                </div>
            </div>
        </div>
