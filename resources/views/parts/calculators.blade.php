    ...
    <div class="col-sm-6">
        <a class="product-card" rel="nofollow" href="{{ route('rate-calculator') }}">
            ...
            <span class="card-content">
                ...
                <br>
                <span class="fs-26 fw-thin card-description">Generate A Custom Rate Sheet</span>
            </span>
        </a>
    </div>
    <div class="col-sm-6">
        <a class="product-card" rel="nofollow" href="{{ route('comparison-calculator') }}">
            ...
            <span class="card-content">
                ...
                <br>
                <span class="fs-26 fw-thin card-description">Compare UPS &amp; FedEx Rates</span>
            </span>
        </a>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <a class="product-card" rel="nofollow" href="{{ route('dim-calculator') }}">
            ...
            <span class="card-content">
                ...
                <br>
                <span class="fs-26 fw-thin card-description">Discover The Impact of DIM Fees</span>
            </span>
        </a>
    </div>
    <div class="col-sm-6">
        <a class="product-card" rel="nofollow" href="{{ route('insurance-calculator') }}#insurance-calculator">
            ...
            <span class="card-content">
                ...
                <br>
                <span3 class="fs-26 fw-thin card-description">Dramatically Cut Insurance Costs</span3>
            </span>
        </a>
    </div>
</div>