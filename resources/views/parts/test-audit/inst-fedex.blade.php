<div id="fedex-instructions" class="hidden prototype">
    ...
    <p class="fs-16 flatGrey fakeOl fw-thin">
        ...
        <span>3 )</span> Press "Download Invoice", select "XML" | "Expanded Invoice Template"
        <br/>
        <span>4 )</span> Press "Create Download", then wait a while (FedEx isn’t as fast as us) <br/>
