<div id="billing-center-paper" class="instructions">
    <p class="fs-16 flatGrey fakeOl fw-thin">
        ...
        <span>4 )</span> Click an Invoice Number that has a high dollar amount, and is at least a week old.<br/>
        <span>5 )</span> Click "View/Download Invoice Data"<br/>
        <span>6 )</span> Select "UPS Billing Data (.csv Format, <b>250</b> data elements)" and press "Submit"<br/>
    </p>
