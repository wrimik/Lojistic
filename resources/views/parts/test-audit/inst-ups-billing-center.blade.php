<div id="billing-center" class="instructions">
    <p class="fs-16 flatGrey fakeOl fw-thin">
        ...
        <span>3 )</span> Press "View/Download Invoice Data" <br/>
        <a class="btn btn-info inst-btn" data-target="#billing-center-paper" data-title="UPS Billing Center, Paper">
            Wait, I got a PDF!?
        </a>
        <br/>
        <span>4 )</span> Select "UPS Billing Data (.csv Format, <b>250</b> data elements)" and press "Submit"<br/>
    </p>
