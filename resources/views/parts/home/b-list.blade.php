<section id="b-list" class="white">
    <span class="tri tri-20 navy widowspeak" style="border-top-color:#00344b;"></span>
    <div class="container">
        <div class="row">
            <div class="col-sm-4 text-center b-list-highlight">
                <b class="fs-18 navy">FREIGHT MANAGEMENT</b>
                <br/>
        ...
        <div class="container">
            <div class="col-xs-12 text-center">
                <br/>
                <b class="fs-20 navy">
                    FEELING THE IMPACT OF THE 2016 RATE INCREASE? <br>
            ...
            <!-- square blue boxes -->
            <div class="c-list-highlight pull-right">
                <b class="navy">
                    UPS &amp; FEDEX <br/>
                    RATES COMPARISON
                </b>
