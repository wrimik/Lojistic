    ...
    <div class="container">
        <nav>
            <div class="col-sm-4 col-xs-12 np">
                <a class="white uppercase" rel="nofollow" href="https://www.lojistic.com/greater-good">
                   Greater Good Collective
                </a>
            </div>
            <div class="minimal-nav-right text-right hidden-xs fs-16 col-xs-12 col-sm-8">
                <span class="white uppercase" rel="nofollow" href="#">giving back to the community </span>
                &nbsp; | &nbsp;
                    <span class="white" rel="nofollow" href="#">
