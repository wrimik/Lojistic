...
@section('meta')
    @include('layouts.inc.flat-meta', [
        'title' => 'History Of Shipping And Trade Along The Panama Canal',
        'description' => 'Read our article "History Of Shipping And Trade Along The Panama Canal".',
        'keywords' => '',
    ])
@overwrite
@section('content')
    <section class="white">
        <div class="container">
            <article>
            <h2>History of Shipping and Trade Along the Panama Canal</h2>
            <p>The Panama Canal is probably the most popular and captivating tourist attraction
                ...
                completed the canal in 1914 and saved voyagers around 8,000 nautical miles (12,875 km)
                of journey from the Atlantic to the Pacific Ocean that originally required ships to go
                around Cape Horn in South America&rsquo;s southern tip. Navigating the waters of Cape Horn
                is hazardous due to large waves and strong winds in the area.
            </p>

            <p>The king of Spain, Charles I who was also the Holy Roman Emperor, Charles V hatched the
                idea of building the Panama Canal in the 16<sup>th</sup> century. In 1534, he ordered a
                study of a route through Panama that will hugely cut the travel time between Spain and
                Peru to enhance the economic growth of Spain. Charles V also realized that the Panama
                Canal could bring Spain a tactical advantage over the military forces of Portugal.
                The bid of Spain to start the canal project was completely abandoned when wars in
                Europe started during that time. It was the turn of the French government to
                attempt building the Panama Canal in 1882. France, however, gave up the project
                due to lack of funds and after suffering plagues from diseases that caused the
                loss of lives of about 20,000 people working on the construction of the canal.
                Its haphazard approach to digging the canal also led to costly and disastrous landslides.
            </p>
            ...
            <p>The interest of the U.S. on the Panama Canal was motivated by the gold rush in California
                ...
                through Philippe Bunau-Varilla, a French businessman. A treaty known as the Hay-Bunau-Varilla
                Treaty was ratified by both countries in 1904 that gave the U.S. exclusive and perpetual
                rights to the canal of the Isthmus of Panama. The republic of Panama, in return, received an
                outright compensation of US$10 million and will receive after nine years the amount of
                US$250,000 per year. The U.S. is also obliged by the treaty to protect the independence of
                Panama. In the 1960s, tension developed as Panamanians started to question the treaty that
                ...
                of the Panama Canal as an international waterway. As a neutral facility, every vessel is
                guaranteed safe passage even during war.
            </p>
            ...
            <p>Modern shipping has progressed so much since the Panama Canal started operating almost a
                ...
                to expand and meet the requirements of the maritime industry. Panama&rsquo;s economy will
                eventually be adversely affected. Panama has addressed this concern with an ‘expansion project
                on the Panama Canal that started in 2007 and expected to be completed in 2014. The expansion
                will double the size of the ship that the Panama Canal can handle, thus, increasing the volume
                of goods that will be transported through the canal.
            </p>
