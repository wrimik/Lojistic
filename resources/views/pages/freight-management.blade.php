...
@section('meta')
    @include('layouts.inc.flat-meta', [
        'title'       => 'Freight Management Services - Lojistic',
        'description' => 'Lojistic freight management services can help your transportation objectives and overcome challenges. Call to learn more about our Freight management services.',
        'keywords'    => 'freight management, freight auditing, freight brokerage, freight negotiation, transportation software, audit and pay',
    ])
@overwrite
@section('content')
