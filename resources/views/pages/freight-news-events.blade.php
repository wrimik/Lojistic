...
@section('meta')
    @include('layouts.inc.flat-meta', [
        'title'       => 'Freight Shipping News & Events - Lojistic',
        'description' => 'Get the latest news from Lojistic about freight shipping, and how to reduce shipping costs with an UPS audit or Fedex audit.',
        'keywords'    => 'Reduce Shipping Costs, Freight Shipping, UPS Audit, Fedex Audit, Lojistic',
    ])
@overwrite
@section('content')
    <section>
        <div class="container">
            <article>
                ...
                <hr/>
                <h3>
                    Source Consulting Featured on 3PL News
                </h3>
                <p>
                ...
                <hr/>
                <h3>
                    Source Consulting and Global Logistics Media Partnership
                </h3>
                <p>
                ...
                <hr/>
                <h3>
                    Source Consulting's Supply Chain Success Story Featured on Supply Chain Digital
                </h3>
                <p>
                ...
                <hr/>
                <h3>
                    Source Consulting CEO Luke Kupersmith Featured in CEO World's Magazine
                </h3>
                <p>
                ...
                <hr/>
                <h3>
                    Source Consulting Joins Inc. Magazine's "500 Fastest Growing Companies" List
                </h3>
                <p>
    ...
    <section class="silver">
        <div class="container">
            <article>
                ...
                <hr/>
                <h3>
                    DHL discontinues domestic US services January 30, 2009
                </h3>
                <hr/>
                <h3>
                    UPS no longer refunding fuel surcharge on late shipments effective Sept 2, 2008
                </h3>
        </article>
    </div>
</section>
