            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center" style="padding-top:35px;width:90%;">
                ...
                <tr>
                    <td style="font-size:16px;line-height:24px;color:#353535;">
                        Thanks for using our FedEx &amp; UPS Rates Calculator! For your convenience,
                        we have attached your custom rate sheet and hope you will find it useful.
                        Feel free to <a href="{{route('rate-calculator')}}">bookmark the Rates Calculator</a> for future use.
                    </td>
                </tr>
                <tr>
                    <td style="font-size:16px;line-height:24px;color:#353535;padding-top:20px;">
                        We’ve found that many shippers who create custom rate sheets are interested
                        to hear more about how they can improve their shipping rates in general.
                        The Lojistic <a href="{{ url('carrier-contract-negotiation') }}">Carrier Contract Negotiation</a>
                        services can help ensure that your rates are best in class.
                    </td>
                </tr>
                <tr>
                    <td>
