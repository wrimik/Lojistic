...
class dbc {
    ...
    public $dbname  = 'sourcel3_office';
    private $error_email = 'mike@lojistic.com';
//    private $dbhost = '66.147.244.118';
    private $dbhost = '142.4.12.194';
    private $dbip   = 'box648.bluehost.com';
    private $dbpassword = 'Source101';
    public $app_name = 'Source Consulting Office';
    public $app_signup_url = false;
    public $login_url   = '/index.php';
    public $landing_url = '/dashboard.php';// after a successful login
    ...
    public static function getInstance($public = false) {
        if (!self::$Instance) {
    ...
    function partnerAgentLogin($partner_code){
        $query = "SELECT * FROM users WHERE partner_code = '$partner_code' AND user_type = 'Partner' LIMIT 1;";
...
//        $this->pass_hashed = $pass;
        $query = "SELECT * FROM {$this->dbname} . users " .
    ...
    private function rawQuery($query) {
        ...
        $this->result = $this->db->query($query, MYSQLI_USE_RESULT) or die($this->db->error . '-<br/>' . $query);
    }
